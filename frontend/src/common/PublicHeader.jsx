        ...
        <nav ref={menuRef} className={`navbar ${isMenuActive ? "active" : ""}`} id="navbar" onClick={toggleSubMenu}>
          <ul className="menu" id="menu">
            <li className="menu-item menu-dropdown">
              <span className="menu-link" data-toggle="submenu">English<FontAwesomeIcon icon={faChevronDown}  /></span>
              <ul className="submenu">
                <li className="submenu-item"><a href="#" className="submenu-link">Odia</a></li>
                <li className="submenu-item"><a href="#" className="submenu-link">Hindi</a></li>
              </ul>
            </li>
            <li className="menu-item"><a href="#" className="menu-link">BOOK</a></li>
            <li className="menu-item"><a href="#" className="menu-link">EVENTS</a></li>
            
            <li className="menu-item"><a href="#" className="menu-link">Sign-in</a></li>
