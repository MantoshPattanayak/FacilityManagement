            ...
            <footer className="common-footer">
                ...
                <div className="footer-content">
                    <div className="footer-column1">
                        ...
                        <p className='p_text_ama'>Assuring mass access through Bhubaneswar <br></br> open spaces and
                            ownership management initiative.</p>
                        <div className='Downlad_Appp'>
                            <h1 className='donwload_name'>  Download App</h1>
                            <div className="input-container">
                                <input type='text' className='Input_text_send_mail' placeholder='Enter your email' />
                ...
                <div className="footer-bottom">
                    <p>&copy; 2024 AMA BHOOMI, Bhubaneswar, Odisha. All Rights Reserved.</p>
                </div>
            </footer>
        </div>
