...
export default function EditNotification() {
    ...
    let handleSubmit = async () => {
        ...
        try {
            ...
            toast.success('Notification details updated successfully!', {
        ...
        <div>
            ...
            <div className="form-container">
                <div className="form-heading">
                    ...
                    <div className="grid grid-rows-2 grid-cols-2 gap-y-4 w-[100%]">
                        ...
                        <div className="form-group col-span-2 w-[100%]">
                            ...
                            {
                                (
                                    action == "view" && formData.fileUrl && <a
                                        href={formData.fileUrl ? instance().baseURL + '/static' + formData.fileUrl : ''}
                                        target='_blank'
                                        ...
                                        <div className="image-preview" id="imagePreview">
                                            {
                                                ...
                                                <>
                                                    ...
                                                    <span onClick={(e) => setFormData({ ...formData, ["fileAttachment"]: { name: '', data: '' }, ["fileUrl"]: '' })} className='cursor-pointer text-red-500 text-2xl'><FontAwesomeIcon icon={faClose} /></span>
                                                </>
                                            }
                                            {
