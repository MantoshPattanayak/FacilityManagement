...
const Event_hostPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    organisationName: "Bhubaneswar Development Authority (BDA)",
    organisationPanCardNumber: "NA",
    organisationAddress: "AKASH SHOVA BUILDING, SACHIVALAYA MARG. BHUBANESWAR, 751001",
    // personal Details ------------------------------
    firstName: "BDA",
    lastName: "BDA",
    phoneNo: "",
    emailId: "bdabbsr1983@gmail.com",
    // Bank Details ------------------------------------
    beneficiaryName: "",
    accountType: "",
    bankName: "",
  ...
  async function GetBankDetails() {
    try {
      ...
      console.log('here Response of GetBankDetails API ', res)
  ...
  const handlePaymentSuccess = ({ response, res }) => {
    ...
    toast.success("Event host Request has been Submitted successfully. For next step, please get approval for the event.", {
      autoClose: 2000,
      onClose: () => {
        setTimeout(() => {
          ...
          <form onSubmit={nextStep} className="event-host_1st_Page">
            ...
            <div className="HostEvent_container">
              ...
              <div className="HostEvent_Heading">
                <div className="HeadingTitle9 justify-center mb-4">
                  <h1 className="verify_name_text">Special Event Booking</h1>
                </div>
