...
export default function CreateFacilityType() {
    ...
    let handleSubmit = async () => {
        ...
        try {
            let res = await axiosHttpClient('CREATE_NEW_FACILITYTYPE_API', 'post', formData);
    ...
    return (
        <div>
            <AdminHeader />
            <div className="CreateFacilityTypeContainer">
