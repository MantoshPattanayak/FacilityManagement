      ...
      <BrowserRouter>
        <div>
          ...
          <Routes>
            ...
            <Route path='/Common/CommonTable' element={<ProtectedRoute><CommonTable /></ProtectedRoute>} />
            ...
            {/* ADMIN SECTION - UAC*/}
            <Route path='/UAC/Resource/ListOfResources' element={<ProtectedRoute><ListOfResources /></ProtectedRoute>} />
            <Route path='/UAC/Resource/CreateResource' element={<ProtectedRoute><CreateResource /></ProtectedRoute>} />
            <Route path='/UAC/Resource/EditResource' element={<ProtectedRoute><EditResource /></ProtectedRoute>} />
            ...
            {/* DASHBOARD SECTION */}
            <Route path='/Dashboard/AdminDashboard' element={<ProtectedRoute><AdminDashboard/></ProtectedRoute>} />
